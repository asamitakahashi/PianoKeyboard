...
class Demo {
    ...
    func notes() {
        ...
        sequence = Sequence(delay: 0.5, functions: {
            ...
            self.keyboard.highlightKey(noteNumber: 61, color:
                UIColor.blue.withAlphaComponent(alpha))
        },{
            self.keyboard.highlightKey(noteNumber: 62, color:
            ...
            self.keyboard.highlightKey(noteNumber: 64, color:
            ...
            self.keyboard.highlightKey(noteNumber: 67, color:
                UIColor.blue.withAlphaComponent(alpha))
        },{
            self.keyboard.highlightKey(noteNumber: 68, color:
                UIColor.green.withAlphaComponent(alpha))
        })
    }
